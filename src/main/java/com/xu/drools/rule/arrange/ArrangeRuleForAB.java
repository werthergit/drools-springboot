...
public class ArrangeRuleForAB {
    ...
    private static void execute(KieContainer kc) {
        KieSession ksession = kc.newKieSession("arrangeForABKS");
        ...
        employee4.setGroup("g2");
        employee4.setOrder(1);
        employee4.setName("rose4");

        Employee employee5 = new Employee();
        employee5.setGroup("g2");
        employee5.setOrder(2);
        employee5.setName("jack");

        Employee employee6 = new Employee();
        employee6.setGroup("g2");
        employee6.setOrder(3);
        employee6.setName("jack6");


        Employee employee7 = new Employee();
        employee7.setGroup("g2");
        employee7.setOrder(4);
        employee7.setName("jack7");
        ...
        ksession.insert(employee6);
        ksession.insert(employee7);
        ...
        System.out.println("");
        System.out.println("emp6:"+employee6.getArrangeJson());
        System.out.println("");
        System.out.println("emp7:"+employee7.getArrangeJson());
    }
}
